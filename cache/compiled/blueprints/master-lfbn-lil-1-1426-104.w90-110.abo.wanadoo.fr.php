...
return [
    ...
    'timestamp' => 1603740490,
    'checksum' => '3b0249c2aad76f5be90491e2ae8f3311',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.aura.output-sd' => [
                ...
                'name' => 'plugins.aura.output-sd',
                'validation' => 'strict'
            ],
            'plugins.aura.output-og' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.aura.output-og',
                'validation' => 'strict'
            ],
            'plugins.aura.output-twitter' => [
                'type' => 'toggle',
                'label' => 'Twitter Card',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'plugins.aura.output-twitter',
                'validation' => 'strict'
            ],
            'plugins.aura.output-linkedin' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.aura.output-linkedin',
                'validation' => 'strict'
            ],
            'plugins.aura.org-heading' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.aura.org-heading',
                'validation' => 'strict'
            ],
            'plugins.aura.org-name' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Name',
                'validate' => [
                ...
                'name' => 'plugins.aura.org-name',
                'validation' => 'strict'
            ],
            'plugins.aura.org-url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'URL',
                'validate' => [
                ...
                'name' => 'plugins.aura.org-url',
                'validation' => 'strict'
            ],
            'plugins.aura.org-logo' => [
                'type' => 'file',
                'size' => 'large',
                ...
                'name' => 'plugins.aura.org-logo',
                'validation' => 'strict'
            ],
            'plugins.aura.org-facebook-url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Facebook URL',
                'name' => 'plugins.aura.org-facebook-url',
                'validation' => 'strict'
            ],
            'plugins.aura.org-facebook-appid' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Facebook App ID',
                'name' => 'plugins.aura.org-facebook-appid',
                'validation' => 'strict'
            ],
            'plugins.aura.org-twitter-user' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Twitter Username',
                'name' => 'plugins.aura.org-twitter-user',
                'validation' => 'strict'
            ],
            'plugins.aura.org-instagram-url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Instagram URL',
                'name' => 'plugins.aura.org-instagram-url',
                'validation' => 'strict'
            ],
            'plugins.aura.org-linkedin-url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'LinkedIn URL',
                'name' => 'plugins.aura.org-linkedin-url',
                'validation' => 'strict'
            ],
            'plugins.aura.org-pinterest-url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Pinterest URL',
                'name' => 'plugins.aura.org-pinterest-url',
                'validation' => 'strict'
            ],
            'plugins.aura.org-youtube-url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'YouTube URL',
                'name' => 'plugins.aura.org-youtube-url',
                'validation' => 'strict'
            ],
            'plugins.aura.org-wikipedia-url' => [
                'type' => 'text',
                'size' => 'large',
                'label' => 'Wikipedia URL',
                'name' => 'plugins.aura.org-wikipedia-url',
                'validation' => 'strict'
            ],
            'plugins.email' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'aura' => [
                    'enabled' => 'plugins.aura.enabled',
                    'output-heading' => 'plugins.aura.output-heading',
                    'output-sd' => 'plugins.aura.output-sd',
                    'output-og' => 'plugins.aura.output-og',
                    'output-twitter' => 'plugins.aura.output-twitter',
                    'output-linkedin' => 'plugins.aura.output-linkedin',
                    'org-heading' => 'plugins.aura.org-heading',
                    'org-name' => 'plugins.aura.org-name',
                    'org-url' => 'plugins.aura.org-url',
                    'org-logo' => 'plugins.aura.org-logo',
                    'org-facebook-url' => 'plugins.aura.org-facebook-url',
                    'org-facebook-appid' => 'plugins.aura.org-facebook-appid',
                    'org-twitter-user' => 'plugins.aura.org-twitter-user',
                    'org-instagram-url' => 'plugins.aura.org-instagram-url',
                    'org-linkedin-url' => 'plugins.aura.org-linkedin-url',
                    'org-pinterest-url' => 'plugins.aura.org-pinterest-url',
                    'org-youtube-url' => 'plugins.aura.org-youtube-url',
                    'org-wikipedia-url' => 'plugins.aura.org-wikipedia-url'
                ],
                'email' => [
